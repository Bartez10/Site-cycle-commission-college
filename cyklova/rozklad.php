...
<div class="logo1">
  ...
  <div class="main2" style="height: 100%;  margin-bottom: 30px; border-bottom: solid; border-bottom-color: #072C53; margin-bottom: 30px; padding-bottom:30px;">
   
    <p><h2 class="zagolovok">Розклад занять</h2></p>
    <p>
    <?php include 'function_rozklad.php'?>
   <div id="comp-jd03od5l" class="txtNew" data-packed="false" style="display: flex;justify-content: center;">
</div>
 <?php $posts = get_posts();
   ?>
  <?php foreach ($posts as $post):?>
      <iframe style="width: 80vw; height: 90vh;" src="<?=$post['img']?>" width="900vw" height="500vw" frameborder="0" style="border:0; " allowfullscreen=""></iframe> 
<?php endforeach; ?> 
