<?php
  $page_title = 'Пошук новин';
  require_once 'header.php';
?>
<?php 
$search_q=$_POST['search_news'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT text1, title, img, date FROM news Where title LIKE '%$search_q%'");
...
$img = null;
$date = null;
$ddd = "Вказаної новини не знайдено";
}
...
<div class="text" >
  ...
  <div class="date" style="color: gray; margin-bottom: 1vw;margin-left: 1vw;"><?php echo "$date"; ?></div>
