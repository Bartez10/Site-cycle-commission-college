<?php
  $page_title = 'Пошук по історії';
  require_once 'header.php';
?>
<?php 
$search_q=$_POST['search_history'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT text, title FROM history Where title LIKE '%$search_q%'");
...
$text = null;
$img = null;
$ddd = "Вказаної події не знайдено";
}
...
<body style="width: 100%;">
 ...
 <div class="logo1">
  ...
  <input type="search" name="search_history" required placeholder="Пошук по історії. Введіть дані для пошуку" class="sea1" style="color: white;">
...
<div class="main1 "style="height: 100% background-color: blue;margin-top: 2vw; margin-bottom: 5vw;"> 
  ...
  <div class="main2" style="height: 100%;  background-color: white; margin-top: 2vw;border-bottom: solid; border-bottom-color:  #072C53;margin-bottom: 30px;">
<div class="text" >
