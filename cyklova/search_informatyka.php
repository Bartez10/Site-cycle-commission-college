<?php
  $page_title = 'Пошук олімпіади з інформатики';
  require_once 'header.php';
  ?>
<?php 
$search_q=$_POST['search_informatyka'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT text, rik FROM informatyka Where rik LIKE '%$search_q%'");
...
$ddd = "Результат пошуку";}
  ...
  $rik = null;
$text = null;
$ddd = "Вказаної олімпіади з інформатики не знайдено";
}
