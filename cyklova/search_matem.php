<?php
  $page_title = 'Пошук олімпіади з математики';
  require_once 'header.php';
  ?>
<?php 
$search_q=$_POST['search_matem'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT text, rik FROM matem Where rik LIKE '%$search_q%'");
...
$ddd = "Результат пошуку";}
  ...
  $rik = null;
$text = null;
$ddd = "Вказаної олімпіади з математики не знайдено";
}
...
<div class="logo1">
  ...
  <div class="main2" style="height: 100%;  margin-bottom: 30px; border-bottom: solid; border-bottom-color: #072C53; margin-bottom: 30px; padding-bottom: 40px;padding-top: 10px;">
