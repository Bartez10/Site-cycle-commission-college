<?php
  $page_title = 'Пошук дипломної';
  require_once 'header.php';
?>
<?php 
$search_q=$_POST['search_diploma'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT tema, student, kerivnyk FROM diploma Where tema LIKE '%$search_q%' OR student LIKE '%$search_q%'");
if($itog = mysqli_fetch_array($q))
	{	$tema = $itog['tema'];
$student = $itog['student'];
$kerivnyk = $itog['kerivnyk'];
$ddd = "Результат пошуку";}
else{
	$tema = null;
$student = null;
$kerivnyk = null;
$ddd = "Вказаної дипломної не знайдено";
}
...
<div class="main1_sublect "style="height: 100% background-color: blue;margin-top: 2vw; margin-bottom: 5vw;"> 
  </div>
  <div class="main2_sublect" style="height: 100%;  background-color: white; margin-top: 2vw; border-bottom: solid; border-bottom-color: #072C53; margin-bottom: 30px;">
<div class="text" >
    <h2 class="zagolovok"><?php echo "$ddd"; ?></h2>
    </div>
    
<TABLE border = "2" cellpading ="2" cellspacing = "0" width = "100%" align = "center" style="margin-bottom: 55px; margin-top:50px;" class="table_font" >
...
<tr>
    ...
    <td><font><b><?php echo "$student"; ?></b></font></td>
     <td><font><b><?php echo "$kerivnyk"; ?></b></font></td>
  </tr>

</TABLE>

</div>
  <div class="main1_sublect"style="height: 100%;margin-top: 2vw; margin-bottom: 5vw;">   
  </div>
  </main>
</body>
