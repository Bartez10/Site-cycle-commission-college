<?php
  $page_title = 'Пошук розкладу';
  require_once 'header.php';
?>
<?php 
$search_q=$_POST['search_rozklad'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT img FROM rozklad Where title LIKE '%$search_q%'");
...
$text = null;
$ddd = "Вказаного розкладу не знайдено";
}
...
<body style="width: 100%;">
 ...
 <div class="logo1">
  <form method="post" action="search_rozklad.php" name="f1">
    <input class="toggle1" style="font-size: 14px;" type="text" name="search_rozklad" required placeholder="Пошук розкладу" title="Введіть назву групи" />
  ...
  <a href="video.php">Відео</a>
     ...
     <form class="form-search" method="post" action="search_rozklad.php" target="" name="f1">
  <div style="display: flex; justify-content: space-between;">
  <input type="search" name="search_rozklad" required placeholder="Пошук розкладу. Введіть назву групи для пошуку" class="sea1">
  ...
  <div class="main2" style="height: 100%;  margin-bottom: 30px; border-bottom: solid; border-bottom-color: #072C53; margin-bottom: 30px;">
   
    <p><h2 class="zagolovok"><?php echo "$ddd"; ?></h2></p>
     <iframe style="width: 80vw; height: 90vh;" src="<?php echo "$text"; ?>" width="900vw" height="500vw" frameborder="0" style="border:0; " allowfullscreen=""></iframe> 
</div>
  <div class="main1">
