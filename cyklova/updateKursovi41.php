...
<div style="display: flex; justify-content: center; ">
   <?php
$kursovi4_id = $_GET['id'];
$kursovi411 = mysqli_query($connection, "SELECT * From kursovi2 Where id_kursovi = '$kursovi4_id'");
$kursovi411 = mysqli_fetch_assoc($kursovi411); 
?>
<form style="width: 600px; margin-top:50px;" action="update-kursovi41.php" method="POST" enctype="multipart/form-data" >
  <input type="hidden" name="id" value="<?=$kursovi411['id_kursovi']?>">
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Тема</span>
  </div>
  <input name="tema"  type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?=$kursovi411['tema']?>">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Студент</span>
  </div>
   <input name="student"  type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?=$kursovi411['student']?>">
</div>
