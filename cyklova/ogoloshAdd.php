...
<div>
  <table style="width: 100%;">
    ...
    <?php
    $ogolosh = mysqli_query($connection, "SELECT id_odoloshenya, title FROM ogoloshenya");
    $ogolosh = mysqli_fetch_all($ogolosh);
    foreach ($ogolosh as $ogolo) {
      ?>
       <tr>
         <td><?=$ogolo[0]?></td>
         <td><?=$ogolo[1]?></td>
         <td><a href="updateOgolosh.php?id=<?=$ogolo[0]?>">Змінити</a></td>
         <td><a style="color: red" href="delete-ogolosh.php?id=<?=$ogolo[0]?>">Видалити</a></td>
      </tr>
    <?php
  }
    ?>
...
<form style="width: 600px; margin-top:50px;" action="add-ogolosh.php" method="POST" enctype="multipart/form-data" >
...
<div class="input-group mb-3">
  ...
  <textarea name="text1" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"></textarea>
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
