<?php
  $page_title = 'Пошук випуску';
  require_once 'header.php';
  ?>
<?php 
$search_q=$_POST['search_vypusk'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT * FROM vypusky Where rik LIKE '%$search_q%'");
...
$ddd = "Результат пошуку";}
  ...
  $rik = null;
$text = null;
$ddd = "Вказаного випуску не знайдено";
}

mysqli_free_result($q);
mysqli_close($l);
?>
<link rel="stylesheet" href="vypusknyky.php">
...
<div class="logo1">
  <form method="post" action="search_vypusk.php" name="f1">
    <input class="toggle1" style="font-size: 14px;" type="text" name="search_vypusk" required placeholder="Пошук випуску" title="Введіть рік випуску" />
