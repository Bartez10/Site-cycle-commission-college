<?php
  $page_title = 'Пошук оголошень';
  require_once 'header.php';
?>
<?php 
$search_q=$_POST['search_ogoloshenya'];
 $l = mysqli_connect('localhost', 'root', '', 'pract1');
$search_q = trim($search_q);
$search_q = strip_tags($search_q);
$q=mysqli_query($l, "SELECT text1, title, img FROM ogoloshenya Where title LIKE '%$search_q%'");
...
$text = null;
$img = null;
$ddd = "Вказаного оголошення не знайдено";
}
...
<body style="width: 100%;">
 <header >
  ...
  <div class="logo1">
  <form method="post" action="search_ogoloshenya.php" name="f1">
    <input class="toggle1" style="font-size: 14px;" type="text" name="search_ogoloshenya" required placeholder="Пошук оголошення" title="Введіть дані для пошуку" />
  ...
  <a href="video.php">Відео</a>
      ...
      <form class="form-search" method="post" action="search_ogoloshenya.php" target="" name="f1">
  <div style="display: flex; justify-content: space-between;">
  <input type="search" name="search_ogoloshenya" required placeholder="Пошук оголошення. Введіть дані для пошуку" class="sea1">
...
<div class="main1 "style="height: 100% background-color: blue;margin-top: 2vw; margin-bottom: 5vw;"> 
  ...
  <div class="main2" style="height: 100%;  background-color: white; margin-top: 2vw; margin-bottom: 5vw;border-bottom: solid; border-bottom-color: #072C53; margin-bottom: 30px; padding-bottom: 30px;">
<div class="text" >
    <h2 class="zagolovok"><?php echo "$ddd"; ?></h2>
</div>
  <div id="container" class="vyfl_no_disp" style="margin-top: 40px;position: inherit;">
  <div class="content">
     <div class="title"><h3 style="margin-top: 10px;font-size: 18px;"class="vyk_vyr vyk_vyr1"><?php echo "$title"; ?></h3></div>
