<?php
$page_title = 'Внесення інформації про дні ЦК';
...
<div style="display: flex; justify-content: center; ">
   <?php
$vyhovnack_id = $_GET['id'];
$vyhovnack1 = mysqli_query($connection, "SELECT * From vyhovnack Where id_vyhovna = '$vyhovnack_id'");
$vyhovnack1 = mysqli_fetch_assoc($vyhovnack1); 
?>
<form style="width: 600px; margin-top:50px;" action="update-vyhovnack.php" method="POST" enctype="multipart/form-data" >
  <input type="hidden" name="id" value="<?=$vyhovnack1['id_vyhovna']?>">
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Заголовок</span>
  </div>
  <input name="title"  type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?=$vyhovnack1['title']?>">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Текст</span>
  </div>
  <textarea name="text" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"> <?=$vyhovnack1['text']?></textarea>
</div>
 <button type="submit" class="btn btn-primary">Змінити</button>
 <a href="dayOfCkADD.php" type="button" style="color: white" class="btn btn-primary">Назад</a>
</form>
