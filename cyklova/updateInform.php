<?php
  ...
  $page_title = 'Редагування одімпіад з інформатики';
...
<div style="display: flex; justify-content: center; padding: 20px; flex-wrap: wrap; ">
   <?php
$inform_id = $_GET['id'];
$informat = mysqli_query($connection, "SELECT * From informatyka Where id_informatyka = '$inform_id'");
$informat = mysqli_fetch_assoc($informat); 
?>
<form style="width: 600px; margin-top:50px;" action="update-inform.php" method="POST" enctype="multipart/form-data" >
  <input type="hidden" name="id" value="<?=$informat['id_informatyka']?>">
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Рік проведення</span>
  </div>
  <input name="rik"  type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?=$informat['rik']?>">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
