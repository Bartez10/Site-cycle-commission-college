...
<body>
 ...
 <div class="logo1">
  ...
  <ul class="sequel-dropdown">
  <li class="col_men">
  <a href="informatyka.php">Олімпіада з інформатикик</a>
  </li>
  <li class="col_men">
...
<main>
  ...
  <div class="main2" style="height: 100%; margin-bottom: 30px; border-bottom: solid; border-bottom-color:  #072C53; margin-bottom: 40px; padding-bottom: 40px;">
    <p><h2 style="margin-bottom: 80px;" class="zagolovok">Оголошення</h2></p>
<?php include 'function_ogoloshennya.php'?>
 <section id="news">
   <?php $posts = get_posts();
   ?>
  ...
  <div class="content">
    <div class="title"><h3 style="margin-top: 20px; font-size: 19px"class="vyk_vyr vyk_vyr1"> <?=$post['title'] ?></h3></div>
